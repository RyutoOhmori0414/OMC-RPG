...
{
    public class SkillUserMoveController : PlayableBehaviour
    {
...
#endif
            attackController.SkillUser.position = Vector3.Lerp(attackController.FirstUserPos,
                attackController.SkillMoveTarget,
